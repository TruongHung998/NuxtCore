          ...
          <div class="main-post">
            <div class="item pb-60">
              ...
              <div class="unorder-list mb-30 mt-4">
                ...
                <ul class="rest">
                  <li><strong>Mobile:</strong> React native, Socket.io, Firebase, Log rocket, SignalR, GG Map Api, etc</li>
                  <li><strong>Front End:</strong> Nuxt Js, Socket.io</li>
                  <li><strong>Back End:</strong> Nest Js, .Net, Redis, Elastic search, etc</li>
                </ul>
              </div>
              <div
                style="
